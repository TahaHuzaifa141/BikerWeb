      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="absolute -bottom-6 -left-6 bg-gray-800/80 backdrop-blur-md border border-orange-500/30 rounded-2xl shadow-xl p-8 pulse-glow"
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-lg text-white/80 font-semibold">Epic Rating!</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-orange-500 via-amber-600 to-orange-600 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 pulse-glow">
                <stat.icon className="h-10 w-10 text-white" />
              </div>
              <div className="text-4xl font-black text-white mb-3">{stat.number}</div>
