    ...
    <section id="services" className="py-20 bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="p-6 sm:p-8">
                {/* Icon */}
                <div className="bg-gradient-to-r from-orange-500 to-green-500 w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 shadow-lg">
                  <service.icon className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
                </div>

                {/* Content */}
                <h3 className="text-xl sm:text-2xl font-bold text-orange-300 mb-4">{service.title}</h3>
                ...
                <ul className="space-y-3 mb-6">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center text-gray-300">
                      <div className="w-2 h-2 bg-gradient-to-r from-orange-400 to-green-400 rounded-full mr-3 flex-shrink-0"></div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full px-4 sm:px-6 py-3 rounded-xl font-bold text-base sm:text-lg shadow-xl transition-all duration-300 text-white border-none focus:outline-none"
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="mt-16 bg-gradient-to-r from-primary-600 to-accent-500 rounded-2xl p-6 sm:p-8 md:p-12 text-center text-white"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              className="px-6 sm:px-8 py-4 rounded-2xl font-extrabold text-base sm:text-lg shadow-2xl transition-all duration-300 text-white border-none focus:outline-none focus:ring-4 focus:ring-orange-400/40"
            ...
            <motion.button
              whileHover={{ scale: 1.12, rotate: -2 }}
              whileTap={{ scale: 0.96 }}
              className="px-6 sm:px-8 py-4 rounded-2xl font-extrabold text-base sm:text-lg shadow-2xl transition-all duration-300 text-white border-none focus:outline-none focus:ring-4 focus:ring-amber-400/40"
